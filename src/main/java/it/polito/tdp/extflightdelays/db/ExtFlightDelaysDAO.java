...
import it.polito.tdp.extflightdelays.model.CoppiaVoli;
...
public class ExtFlightDelaysDAO {
	...
	public List<CoppiaVoli> coppieVoli() {
		...
		List<CoppiaVoli> result = new ArrayList<>();
		...
		try {
			...
			while(rs.next()) {
				result.add(new CoppiaVoli(rs.getInt("ORIGIN_AIRPORT_ID"), rs.getInt("DESTINATION_AIRPORT_ID"),
						rs.getInt("media")));
			}
			conn.close();
			return result;
